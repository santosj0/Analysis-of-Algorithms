...
However, the array will have multiple elements that are similar. 
"""
...
for i in range(0, size):
    ...
    # p shows the probability that odd numbers have a higher chance of being selected
    arr = np.random.choice(10, i + 1, p=[0.05, 0.15, 0.05, 0.15, 0.05, 0.15, 0.05, 0.15, 0.05, 0.15])
